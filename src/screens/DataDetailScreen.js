...
export default function RecipeDetailScreen(props) {
    ...
    const [userLocation, setUserLocation] = useState(null); // Assuming you have user's location
    const navigation = useNavigation();

    // Fetch user's location or set it using a location service
    useEffect(() => {
        // Fetch or set user's location
        const userLocationData = { latitude: 37.7749, longitude: -122.4194 }; // Replace with actual user location
                ...
                <View className="flex justify-center">
                    ...
                    <View className="flex justify-center items-center">
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('MapViewScreen', { item, userLocation })}
                        >
